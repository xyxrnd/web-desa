        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item">
                <a class="sidebar-link" href="<?= base_url('admin/berita') ?>">
                    <i class="align-middle" data-feather="user"></i> <span class="align-middle">Berita</span>
                </a>
            </li>

            <li class="sidebar-item">
                <a class="sidebar-link" href="<?= base_url('admin/agenda') ?>">
                    <i class="align-middle" data-feather="log-in"></i> <span class="align-middle">Agenda</span>
                </a>
            </li>
